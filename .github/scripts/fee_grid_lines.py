...
'''
new='''/* Fee table grid lines */
.fee-department-head{border-bottom:2px solid #9fb7d0!important}
.fee-data-table{border-collapse:collapse!important}
.fee-data-table thead th{border-bottom:2px solid #9fb7d0!important;border-right:1px solid #c4d3e2!important}
.fee-data-table tbody td{border-bottom:1px solid #b9cbe0!important;border-right:1px solid #c4d3e2!important}
.fee-data-table thead th:last-child,.fee-data-table tbody td:last-child{border-right:0!important}
